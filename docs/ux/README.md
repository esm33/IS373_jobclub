...
This directory contains UX documentation for the Job Club project.
...
- Page-level architecture and content hierarchy
- User flows
...
- Component patterns (cards, filters, progress indicators)
...
**Primary Font**: Google Sans (headings), Roboto (body)  
**Icons**: Material Icons Rounded  
**Colors**: Purple (#6750A4), Teal (#00BFA5), Orange (#FF6F00)  
