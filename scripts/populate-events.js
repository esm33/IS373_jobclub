...
Materials will be provided, and there will be plenty of time for Q&A and hands-on practice.`,
  ...
  },
  {
    ...
    description:
      "Drop-in session to discuss AI career opportunities, resume reviews, and industry insights with experienced professionals.",
...
This is an informal, drop-in session where you can ask any career-related questions. Bring your resume, LinkedIn profile, or portfolio for feedback!`,
  ...
  },
  {
    ...
    description:
      "Connect with fellow students, alumni, and industry professionals. Build relationships that can launch your career.",
...
This is a great opportunity to practice your elevator pitch, exchange contact information, and build meaningful professional relationships.`,
  ...
  },
  {
    ...
    description:
      "Learn from a startup founder about building and launching AI-powered products in today's market.",
...
- Anyone curious about the startup world`,
  ...
  },
  {
    ...
    description:
      "Collaborative coding session to build or improve your personal portfolio website. Bring your laptop and ideas!",
...
This is a supportive, beginner-friendly environment. All skill levels welcome!`,
    ...
    targetAudience: ["all", "beginners", "intermediate"],
    prerequisites:
      "Laptop with code editor (VS Code recommended), basic coding knowledge",
    materialsProvided:
      "Pizza, drinks, portfolio templates, deployment guides, mentorship",
    status: "published",
    publishedAt: new Date().toISOString(),
  },
];
