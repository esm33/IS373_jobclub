...
class EventsManager {
  ...
  renderEvents() {
    ...
    this.eventsGrid.innerHTML = filteredEvents.map(event => this.createEventCard(event)).join('');
  }
  ...
  getMockEvents() {
    return [
      ...
      },
      {
        ...
        description: 'Drop in for resume reviews, interview prep, and career advice. No appointment needed!',
      ...
      },
      {
        ...
        description: 'Leading experts discuss how AI is transforming healthcare and creating new career opportunities.',
      ...
      },
      {
        ...
        eventType: 'meetup',
        description: 'Monthly networking event with local tech professionals, students, and employers. Pizza provided!',
      ...
      },
      {
        ...
        description: 'Work on your portfolio website with help from mentors. Bring your laptop and ideas!',
